            ...
            <ul class="nav flex-column" id="nav_accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <ul class="submenu collapse">
                        ...
                        <li><a class="nav-link" href="{{ route('admin.candidates.index')}}/0"><i class="fa fa-angle-right" aria-hidden="true"></i> Inactive</a></li>
        ...
        <ul class="nav flex-column" id="nav_accordion">
            ...
            <li class="nav-item has-submenu">
                ...
                <ul class="submenu collapse <?php echo (Route::currentRouteName()=='admin.candidates.show') ? 'show' : ''; ?>">
                    ...
                    <li><a class="nav-link <?php echo ((Route::currentRouteName()=='admin.candidates.show') && (Request::getPathInfo()=='/admin/candidates/0')) ? 'active' : ''; ?>" href="{{ route('admin.candidates.index')}}/0"><i class="fa fa-angle-right" aria-hidden="true"></i> Inactive</a></li>
