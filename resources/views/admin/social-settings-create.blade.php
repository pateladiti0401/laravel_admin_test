                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group label-floating is-empty" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$google_active}} data-bs-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger" name="google_active" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group label-floating is-empty" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$fb_active}} data-bs-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger" name="fb_active" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
