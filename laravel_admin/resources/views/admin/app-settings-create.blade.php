                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="form-group label-floating is-empty" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$fb_login}} data-bs-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger" name="fb_login" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div style="padding-top:15px"></div>
                                                        <div class="form-group label-floating is-empty" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$google_login}} data-bs-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger" name="google_login" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div style="padding-top:15px"></div>
                                                        <div class="form-group label-floating is-empty" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$apple_login}} data-bs-toggle="toggle" data-on="Yes" data-off="No" data-onstyle="success" data-offstyle="danger" name="apple_login" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div style="padding-top:15px"></div>
