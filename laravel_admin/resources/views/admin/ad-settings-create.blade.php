                                ...
                                <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="panel-body">
                                        <div style="float:right;width:100px;">
                                            <input type="checkbox" class="flaged_toggle" @if (!empty($adSettings->disable_inter)) checked="checked" @endif data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="disable_inter" data-size="sm" value=1>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="panel-body">
                                        <div style="float:right;width:100px;">
                                            <input type="checkbox" class="flaged_toggle" @if (!empty($adSettings->disable_banner)) checked="checked" @endif data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="disable_banner" data-size="sm" value=1>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                    ...
                                    <div class="panel-body">
                                        <div style="float:right;width:100px;">
                                            <input type="checkbox" class="flaged_toggle" @if (!empty($adSettings->disable_rewarded)) checked="checked" @endif data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="disable_rewarded" data-size="sm" value=1>
                                        </div>
