                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    ?>
                                                    <input type="checkbox" class="flaged_toggle" {{$status_checked}} data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="active" data-size="sm" value=1 <?php echo $disabled; ?>>
                                                </div>
                                            </div>
