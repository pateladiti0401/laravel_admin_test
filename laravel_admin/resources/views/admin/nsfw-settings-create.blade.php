                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group label-floating is-empty row" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$status_checked}} data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="status" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row cloak">
                                                    <div class="col-sm-12">
                                                        <div class="form-group label-floating is-empty row" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$nudity_checked}} data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="nudity" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group label-floating is-empty row" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$wad_checked}} data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="wad" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group label-floating is-empty row" style="padding: 0px;margin: 0px;">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" class="flaged_toggle" {{$offensive_checked}} data-bs-toggle="toggle" data-on="Enable" data-off="Disable" data-onstyle="success" data-offstyle="danger" name="offensive" data-size="sm" value=1>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
